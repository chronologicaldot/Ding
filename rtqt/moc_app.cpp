...
QT_MOC_LITERAL(3, 18, 14)
    ...
    "App\0toggleStream\0\0togglePlayback\0"
};
...
void *App::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "soundbox::SoundBox::Listener"))
        return static_cast< soundbox::SoundBox::Listener*>(const_cast< App*>(this));
